<template>
  <div class="my-invite-codes-container">
    <div class="my-invite-codes-main">
      <div class="my-invite-code-wrap">
        ...
        <div class="my-invite-code-bottom">
          <div
            class="my-invite-qr-code"
            v-if="qrcodeSrcIndustry"
            @touchstart="touchStart"
            @touchend="touchEnd"
            @click="fullScreen(qrcodeSrcIndustry)"
          >
      ...
      <div class="my-invite-code-wrap">
        ...
        <div class="my-invite-code-bottom">
          <div
            class="my-invite-qr-code"
            v-if="qrcodeSrcCampus"
            @touchstart="touchStart"
            @touchend="touchEnd"
            @click="fullScreen(qrcodeSrcCampus)"
          >
      ...
      <div class="my-invite-code-wrap">
        ...
        <div class="my-invite-code-bottom">
          <div
            ...
            @touchstart="touchStart"
            @touchend="touchEnd"
            @click="fullScreen(qrcodeSrcGuest)"
          >
    ...
    <div
      class="my-invite-codes-tip-layer"
      @click.self="closeTipLayer"
      v-if="tipShow"
      @touchmove="prevDef($event)"
    >
  ...
  methods: {
    ...
    buildUrl: function(codeType, inviteCode, urlType) {
      let url = `${window.location.origin +
        baseUrl}/partner/#/codeshare?ct=${codeType}&c=${inviteCode}`;
      if (process.env.NODE_ENV === 'development') {
        url = `${window.location.origin}/#/codeshare?ct=${codeType}&c=${inviteCode}`;
      }
      if (urlType === 'public') {
        url = `${window.location.origin +
          baseUrl}/packageSalary/share?url=${encodeURIComponent(url)}`;
      }
      return url;
    },
    buildQRUrl: function(inviteCode) {
      let url = `${window.location.origin +
        baseUrl}/register/wx/oAuth/userInfo?info=inviteCode=${inviteCode}`;
      return url;
    },
