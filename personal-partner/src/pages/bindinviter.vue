  ...
  <div class="bind-inviter-container">
    <div class="invite-code-input">
      <input
        ...
        maxlength="6"
        :readonly="isQrScanEntering"
        :disabled="isQrScanEntering"
        :class="{'input-disabled': isQrScanEntering}"
      />
    </div>
    ...
    <div v-if="isBindModal" class="bind-inviter-modal">
      ...
      <div class="bind-modal-btn">
        ...
        <div
          class="bind-modal-confirm"
          :style="isBind ? 'background: #ccc;' : ''"
          @click="bindInviter"
        >绑定</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    bindInviter: function() {
      ...
      let reqPrams = getRequestParams(
        url,
        params,
        this.bindInviterSuc,
        this.bindInviterFail,
        ''
      );
      Indicator.open();
